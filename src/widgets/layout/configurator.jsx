...
export function Configurator() {
  ...
  React.useEffect(() => {
    const stars = fetch(
      "https://api.github.com/repos/creativetimofficial/tailwind-dashboard-react"
    )
      ...
      <div className="py-4 px-6">
        ...
        <div className="mb-12">
          ...
          <div className="my-8 flex flex-col gap-4">
            <a
              href="https://www.creative-tim.com/product/tailwind-dashboard-react?rel=mtdr"
              target="_black"
            >
          ...
          <a
            ...
            href="https://github.com/creativetimofficial/tailwind-dashboard-react"
            target="_blank"
            rel="noreferrer"
          >
            <Chip
